...
private:
    ...
    void print_available_vulkan_extensions() const {
    ...
    //looking for graphing card
    //It's all for far future, because I have only one on my laptop
    ...
    void createLogicalDevice() {
        ...
        VkPhysicalDeviceFeatures deviceFeatures{}; //for far future
    ...
    //checking that all device extensions are avaliable for device
    ...
    //checking that all extensions compatible with window surface and chosing the best variant
    ...
    static std::vector<char> readFile(const std::string& filename) {
        std::ifstream file(filename, std::ios::ate | std::ios::binary); //some magic for me
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        auto model_rotate_y = glm::rotate(glm::mat4(1.0f), y_rotate_param * glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        auto model_rotate_z = glm::rotate(glm::mat4(1.0f), z_rotate_param * glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));

        ubo.model = model_rotate_y * model_rotate_z;

        ubo.view = glm::lookAt(glm::vec3(2.0f, 2.0f, 2.0f), glm::vec3(0.0f, 0.0f, 0.0f),
                               glm::vec3(0.0f, 0.0f, 1.0f));

        ubo.proj = glm::perspective(glm::radians(zoom_param),
